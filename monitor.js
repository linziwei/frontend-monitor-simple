...
// Performance API，其中又包括了 High Resolution Time 、 Frame Timing 、 
// Navigation Timing 、 Performance Timeline 、Resource Timing 、 User Timing 等诸多具体标准
    ...
    pMonitor.bindEvent = () => {
        ...
        window.onload = e => {
            ...
            if (window.requestIdleCallback) {
                window.requesstIdleCallback(pMonitor.logPackage)
            } else {
